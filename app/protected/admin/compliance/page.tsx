    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div role="alert" className="alert alert-warning">
                  <span>Warning Issues: 3</span>
                </div>

                <div role="alert" className="alert alert-info">
                  <span>Info Issues: 12</span>
                </div>

                <div role="alert" className="alert alert-success">
                  <span>Resolved Issues: 156</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="space-y-4">
            {/* Violation 1 */}
            <div className="border border-error rounded-lg p-6 bg-error/10">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="text-lg font-medium text-error-content">Document Signature Verification Failed</h3>
                  <p className="text-sm text-error">Document ID: DOC-2024-001 • User: john.smith@example.com</p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
                <div>
                  <p className="text-sm font-medium text-error-content">Issue Type</p>
                  <p className="text-sm text-error">Digital signature validation failed</p>
                </div>
                
                <div>
                  <p className="text-sm font-medium text-error-content">Detected</p>
                  <p className="text-sm text-error">2 hours ago</p>
                </div>
                
                <div>
                  <p className="text-sm font-medium text-error-content">ETA 2019 Impact</p>
                  <p className="text-sm text-error">Signature non-compliance</p>
                </div>
              </div>
              
              <div className="mb-4">
                <p className="text-sm font-medium text-error-content mb-2">Description:</p>
                <p className="text-sm text-error">
                  The digital signature on _document DOC-2024-001 failed cryptographic validation. 
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <span className="text-sm text-error">Status: Open</span>
                  <span className="text-sm text-error">Assigned to: Compliance Team</span>
                </div>
            ...
            <div className="border border-yellow-200 rounded-lg p-6 bg-yellow-50">
              ...
              <div className="mb-4">
                ...
                <p className="text-sm text-yellow-700">
                  KYC verification for SME _user jane.doe@example.com has exceeded the 30-day limit. 
            ...
            {/* Violation 3 */}
            <div className="border border-info rounded-lg p-6 bg-info/10">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="text-lg font-medium text-info-content">Audit Log Incomplete</h3>
                  <p className="text-sm text-info">System: Document Processing Service</p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
                <div>
                  <p className="text-sm font-medium text-info-content">Issue Type</p>
                  <p className="text-sm text-info">Audit trail gap</p>
                </div>
                
                <div>
                  <p className="text-sm font-medium text-info-content">Detected</p>
                  <p className="text-sm text-info">3 days ago</p>
                </div>
                
                <div>
                  <p className="text-sm font-medium text-info-content">ETA 2019 Impact</p>
                  <p className="text-sm text-info">Audit trail requirement</p>
                </div>
              </div>
              
              <div className="mb-4">
                <p className="text-sm font-medium text-info-content mb-2">Description:</p>
                <p className="text-sm text-info">
                  A 2-hour gap was detected in the audit log for the _document processing service. 
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <span className="text-sm text-info">Status: Under Investigation</span>
                  <span className="text-sm text-info">Assigned to: IT Team</span>
                </div>
                <div className="flex space-x-2">
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="link link-info" disabled>
                      Download
                    </button>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-success/10 border border-success/20 rounded-lg">
                  <span className="text-sm font-medium text-success-content">Operational Risk</span>
                  <span className="text-sm text-success">Low (15/100)</span>
                </div>
                
                <div className="flex items-center justify-between p-3 bg-warning/10 border border-warning/20 rounded-lg">
                  <span className="text-sm font-medium text-warning-content">Compliance Risk</span>
                  <span className="text-sm text-warning">Medium (35/100)</span>
                </div>
                
                <div className="flex items-center justify-between p-3 bg-info/10 border border-info/20 rounded-lg">
                  <span className="text-sm font-medium text-info-content">Security Risk</span>
                  <span className="text-sm text-info">Low (20/100)</span>
                </div>
                
                <div className="flex items-center justify-between p-3 bg-success/10 border border-success/20 rounded-lg">
                  <span className="text-sm font-medium text-success-content">Technology Risk</span>
                  <span className="text-sm text-success">Low (25/100)</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-warning mt-1">Increasing trend</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-success mt-1">Decreasing trend</p>
                </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="space-y-6">
            <div className="bg-info/10 border-info/20 rounded-lg p-6">
              <h3 className="font-medium text-info-content mb-3">Smart Compliance Insights</h3>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-info rounded-full"></div>
                  <span className="text-sm text-info">3 compliance violations detected in the last 24 hours</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-info rounded-full"></div>
                  <span className="text-sm text-info">Compliance risk has increased by 5% this month</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-info rounded-full"></div>
                  <span className="text-sm text-info">ETA 2019 compliance rate is above industry average</span>
                </div>
              </div>
            </div>
